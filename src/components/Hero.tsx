      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8">
          ...
          <div className="py-12 md:py-20">
            ...
            <p className="mt-6 max-w-xl text-zinc-600 dark:text-zinc-300">{subtitle}</p>

            <div className="mt-8">
              <Link
                href="#"
                className="inline-block rounded-full bg-black text-white px-6 py-3 text-sm shadow hover:opacity-95"
              >
                Learn More
              </Link>
            </div>
          ...
          <div className="relative flex items-center justify-center py-12 md:py-20">
            <div className="w-full max-w-md md:max-w-lg lg:max-w-xl aspect-[4/3] rounded-3xl overflow-hidden bg-gradient-to-b from-white/60 to-white/40 dark:from-black/40 dark:to-black/30 relative">
              {/* main image - use fill */}
              <Image src={image} alt="Hero" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-contain" />

              {/* floating ingredients */}
              <Image
                src="/images/ingredient-meat.png"
                alt="meat"
                width={64}
                height={64}
              ...
              />
              <Image
                src="/images/ingredient-onion.png"
                alt="onion"
                width={48}
                height={48}
