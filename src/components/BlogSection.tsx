...
export default function BlogSection({
  ...
  const defaultPosts = [
    { id: 1, image: "/images/blog/1.jpg", caption: "Fresh salad with seasonal greens", likes: 44486, date: "September 10" },
    { id: 2, image: "/images/blog/2.jpg", caption: "Stack of pancakes with berries", likes: 44486, date: "September 10" },
    { id: 3, image: "/images/blog/3.jpg", caption: "Chopped onions and herbs prep", likes: 44486, date: "September 10" },
    ...
    <section className="w-full py-12">
      <div className="mx-auto max-w-6xl px-6 text-center">
        ...
        <div className="flex justify-center">
          <Link href="#" className="inline-flex items-center gap-3 bg-black text-white px-6 py-3 rounded-full shadow hover:opacity-95">
            Visit Our Instagram
            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2a5 5 0 00-5 5v10a5 5 0 005 5h0a5 5 0 005-5V7a5 5 0 00-5-5zM12 7a5 5 0 110 10 5 5 0 010-10z"/></svg>
          </Link>
        </div>
      </div>
    </section>
